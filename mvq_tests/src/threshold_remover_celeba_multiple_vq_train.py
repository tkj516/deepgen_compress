...
from vq_tests.pix2pix_models.pix2pix_model_multiple_vq import *
...
parser.add_argument('--num_vq', type=int, default=4, help='number of vector quantizers')
# dataset parameters
