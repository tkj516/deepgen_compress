...
parser.add_argument('--restore_file', type=str, default='/fs/data/Masters_Thesis/pixel_models/results/pixelcnnpp/2021-04-03_02-38-57/checkpoint.pt', help="Directory with checkpoint")
...
class Decoder(nn.Module):
    ...
    def forward(self):
        ...
        self.normalized_input = F.tanh(self.input)
        self.logits = self.source(self.normalized_input, None)
...
def test_source_code_decode():
    ...
    ax[1].imshow((F.tanh(decoder.input.reshape(h, w)).cpu().numpy() + 1)/2)
