...
if __name__ == "__main__":
    ...
    ax.plot(q_interp, sep_threshold_pgm_interp, 'o-', label='sep-thresh PGM', markerfacecolor="None", ms=10)
    ax.plot(q_interp, sep_threshold_spn_interp, '^-', label='sep-thresh SPN', markerfacecolor="None", ms=10)
