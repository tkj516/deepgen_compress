...
from demo_bp_gray import SourceCodeBP
...
class Demo():
    ...
    def compute_dataset_rate(self):
        ...
        filepath = os.path.join('demo_gray', args.dataset, args.source_type + '_' + args.phase, os.path.basename(args.root_dir) + '.json')
        os.makedirs(os.path.join('demo_gray', args.dataset, args.source_type + '_' + args.phase), exist_ok=True)
