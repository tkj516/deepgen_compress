'''
This was taken from 
https://github.com/facebookresearch/NeuralCompression/blob/main/neuralcompression/layers/_generalized_divisive_normalization.py
'''
...
from layers.non_negative_parameterization import NonNegativeParameterization
