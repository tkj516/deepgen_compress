'''
This is taken from 
https://github.com/facebookresearch/NeuralCompression/blob/main/neuralcompression/layers/_non_negative_parameterization.py
'''
...
import layers.functional as ncF
