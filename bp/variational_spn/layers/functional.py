'''
This is taken from 
https://github.com/facebookresearch/NeuralCompression/blob/main/neuralcompression/functional/_lower_bound.py
'''
...
class _LowerBound(Function):
    ...
    def forward(ctx, *args):
        ...
        # TODO: The max operator requires x and bound to be on the same device
        ...
        bound = torch.tensor(bound, dtype=x.dtype).to(x.device)
