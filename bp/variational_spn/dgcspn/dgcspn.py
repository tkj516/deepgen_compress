...
from dgcspn.distributions import SpatialIndicatorLayer, SpatialDiscreteLogisticLayer, SpatialGaussianLayer
...
class DgcSpn(AbstractModel):
    ...
    def forward(self, x, mean, log_scale, external_beliefs=None):
        """
        ...
        x = self.base_layer(x, mean, log_scale)
    ...
    # @torch.no_grad()
    def mpe(self, x, mean, log_scale, external_beliefs=None):
        """
        ...
        z = self.base_layer(x, mean, log_scale)
