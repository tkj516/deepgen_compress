...
parser.add_argument('--checkpoint', type=str, default='isinggan_checkpoints/12-03-2021_01-45-26/checkpoint.pth', help="Pre-trained model checkpoint")
...
def test_source_code_bp():
    ...
    ax[2].imshow(np.argmax(source_code_bp.B.detach().cpu().numpy(), axis=-1))
