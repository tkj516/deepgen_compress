...
parser.add_argument('--display_freq', type=int, default=3200, help='frequency of showing training results on screen')
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        for i, sample in enumerate(dataloader):
            ...
            if total_iters % args.display_freq == 0:
                ...
                visuals['compressed' + str(i*batch_size + j)] = sample['compressed_sample'][j, ...]
                visuals['original' + str(i*batch_size + j)] = sample['sample'][j, ...]
                visuals['output_recon_image' + str(i*batch_size + j)] = detached_out[j, ...]

                writer.add_image(f'{epoch}/{i}/compressed', visuals['compressed' + str(i*batch_size + j)], i)
